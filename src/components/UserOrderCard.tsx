...
function UserOrderCard({ order }: { order: IOrder }) {
    ...
    return (
        <motion.div
            ...
            <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-gray-100 px-5 py-4 bg-linear-to-b from-green-50 to-white'>
                <div><h3 className='text-lg font-semibold text-gray-800'>order <span className='text-green-700 font-bold'>#{order?._id?.toString().slice(0, 6)}</span></h3>
            ...
            <div className='p-5 space-y-4'>
                ...
                {order.assignedDeliveryBoy && <><div className='mt-4 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-center justify-between'>
                    ...
                    <button className='w-full flex items-center justify-center gap-2 bg-green-600 text-white font-semibold px-4 py-2 rounded-xl shadow hover:bg-green-700 transition'><Truck size={18} />Track Your Order</button>
                </>
                }
                ...
                <div className='border-t border-gray-200 pt-3'>
                    ...
                    >
                        ...
                        <span className='flex items-center gap-2'>
                            ...
                            {expand ? "Hide Items" : `View ${order.items.length} Items`}
                        </span>

                        {expand ? <ChevronUp size={16} className='text-green-600' /> : <ChevronDown size={16} className='text-green-600' />}
                    </button>
                        ...
                        <div className='mt-3 space-y-3'>
                            {order.items.map((item, index) => (
                                <div
                                    ...
                                    <div className='flez items-center gap-3'>
