'use client'
import { Apple, Box, Coffee, Cookie, Heart, Home, Milk, Wheat, ChevronLeft, ChevronRight } from 'lucide-react'
...
function CategorySlider() {
    const categories = [
        ...
        { id: 3, name: "Rice, wheat, & pulses", icon: Wheat, color: "bg-orange-100" },
        { id: 4, name: "Snacks & Biscuits", icon: Cookie, color: "bg-pink-100" },
        { id: 5, name: "Beverages & Juices", icon: Coffee, color: "bg-blue-100" },
        { id: 6, name: "Personal Care & Hygiene", icon: Heart, color: "bg-purple-100" },
        { id: 7, name: "Home Care & Cleaning", icon: Home, color: "bg-indigo-100" },
        { id: 8, name: "Incidental Items", icon: Box, color: "bg-gray-100" },
        { id: 9, name: "Grocery", icon: Box, color: "bg-teal-100", },
    ]
