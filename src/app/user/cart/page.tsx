        ...
        <div className='W-[95%] sm:W-[90%] md:w-[80%] mx-auto mt-8 mb-24 relative'>
            ...
            {cartData.length == 0 ? (
                ...
                >
                    ...
                    <p className='text-gray-600 text-lg mb-6'>Your Cart Is Empty. Please Add Some Items to continoue shopping!</p>
                        ...
                        <AnimatePresence>
                            {cartData.map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className='mt-4 sm:mat-0 sm:ml-4 flex-1 text-center sm:text-left'>
