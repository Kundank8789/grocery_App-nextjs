...
function OrderSuccess() {
    return (
        <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
            ...
            >
                Thank you for your purchase! Your order has been placed and is being processed. You
                can track its status in your <span className='font-semibold text-green-700'>My Orders</span> section.
            </motion.p>
            <motion.div
            ...
            >
                ...
                <div className='absolute top-30 left-[30%] w-2 h-2 bg-green-400 rounded-full animate-bounce' />
